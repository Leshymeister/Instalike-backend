// Controller cuida de todas as responsabilidades de lidar com requisições e respostas
...
export async function atualizarNovoPost(req, res) {
    ...
    try{
        ...
        const descricaoImagem = await gerarDescricaoComGemini(imgBuffer);
        const post = {
            imgUrl: urlImagem,
...
export async function deletarPost(req, res) {
    ...
    try{
        const postDeletado = await apagarPost(id);
